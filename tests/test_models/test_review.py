...
class TestBase(unittest.TestCase):
    """Base test class for tests for the Review class."""
...
class TestReviewAttributes(TestBase):
...
class TestReviewstrMethod(TestBase):
    """Test the Review.str() method."""
...
class TestReviewsaveMethod(TestBase):
    """Test the Review.save() method."""
...
class TestReviewToDictMethod(TestBase):
...
class TestReviewCreateFromDict(TestBase):
    ...
    def setUpClass(cls):
        ...
        cls.other_attrs = {
            'place_id': '940dfc-901f-4af2-93df-e05490bea019',
            'user_id': '68940dbc-901f-4ak2-93df-e05490bea019',
            'text': 'Silent Night by ...'
        }
        cls.all_dict = {**cls.review_dict, **cls.other_attrs}

    def setUp(self):
        """Create custom Review dict."""
        super().setUp()
        self.obj = Review(**self.__class__.all_dict)

    def test_same_class(self):
        """Check that the new object has the same class name as the kwargs."""
        self.assertEqual(self.obj.__class__, Review)
    ...
    def test_other_attributes(self):
        ...
        the new object
        """
        _dict = TestReviewCreateFromDict.other_attrs

...
class TestBase(unittest.TestCase):
    """Base test class for tests for the User class."""
...
class TestUserAttributes(TestBase):
...
class TestUserstrMethod(TestBase):
    """Test the User.str() method."""
...
class TestUsersaveMethod(TestBase):
...
class TestUserToDictMethod(TestBase):
...
class TestUserCreateFromDict(TestBase):
    ...
    def setUpClass(cls):
        ...
        cls.all_dict = {**cls.user_dict, **cls.other_attrs}

    def setUp(self):
        """Create custom User dict."""
        super().setUp()
        self.obj = User(**self.__class__.all_dict)

    def test_same_class(self):
        """Check that the new object has the same class name as the kwargs."""
        self.assertEqual(self.obj.__class__, User)
    ...
    def test_other_attributes(self):
        ...
        the new object
        """
        _dict = TestUserCreateFromDict.other_attrs

...
class TestBase(unittest.TestCase):
    """Base test class for tests for the State class."""
...
class TestStateAttributes(TestBase):
...
class TestStatestrMethod(TestBase):
    """Test the State.str() method."""
...
class TestStatesaveMethod(TestBase):
    """Test the State.save() method."""
...
class TestStateToDictMethod(TestBase):
...
class TestStateCreateFromDict(TestBase):
    ...
    def setUpClass(cls):
        ...
        cls.all_dict = {**cls.state_dict, **cls.other_attrs}

    def setUp(self):
        """Create custom State dict."""
        super().setUp()
        self.obj = State(**self.__class__.all_dict)

    def test_same_class(self):
        """Check that the new object has the same class name as the kwargs."""
        self.assertEqual(self.obj.__class__, State)
    ...
    def test_other_attributes(self):
        ...
        the new object
        """
        _dict = TestStateCreateFromDict.other_attrs

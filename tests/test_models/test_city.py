...
test_path = "_tmp_path_2.json"
memory_path = "_tmp_path_memory_2.json"


class TestBase(unittest.TestCase):
    """Base test class for tests for the City class."""
...
class TestCityAttributes(TestBase):
...
class TestCitystrMethod(TestBase):
    """Test the City.str() method."""
...
class TestCitysaveMethod(TestBase):
    """Test the City.save() method."""
...
class TestCityToDictMethod(TestBase):
...
class TestCityCreateFromDict(TestBase):
    ...
    def setUpClass(cls):
        ...
        cls.other_attrs = {
            'state_id': '6x960dfc-9h1f-4af2-9ddf-305450bea019',
            'name': 'Akansas'
        }
        cls.all_dict = {**cls.city_dict, **cls.other_attrs}

    def setUp(self):
        """Create custom City dict."""
        super().setUp()
        self.obj = City(**self.__class__.all_dict)

    def test_same_class(self):
        """Check that the new object has the same class name as the kwargs."""
        self.assertEqual(self.obj.__class__, City)
    ...
    def test_other_attributes(self):
        ...
        the new object
        """
        _dict = TestCityCreateFromDict.other_attrs
